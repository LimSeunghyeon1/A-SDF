...
def main_function(experiment_directory, continue_from, batch_split):
    ...
    sdf_dataset = asdf.data.SDFSamplesBI(
        data_source=data_source, category=specs['Class'], pkl_path=None, normalize_atc=normalize_atc, split='trn', subsample=num_samp_per_scene, 
        load_ram=False, articulation=specs["Articulation"], num_atc_parts=specs["NumAtcParts"], real_world=True)
    ...
    # TODO: NUM_SCENES: 1개 뿐이기 때문에 1... 1228
