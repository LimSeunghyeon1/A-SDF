        ...
        if infer_with_gt_atc:
            ...
            if bi_mode:
                ...
                if normalize_atc:
                    ...
                    assert qpos_limit.shape[-1] == 2, qpos_limit
                    print("qpos limit", qpos_limit.shape) # [1]
                    ...
                    #atc vec도 바꾸어주기
                    assert len(atc_vec.shape) == 2 and atc_vec.shape[0] == 1 and atc_vec.shape[1] == num_atc_parts, atc_vec.shape
